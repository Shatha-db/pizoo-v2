          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100" data-testid={`feature-card-${index}`}>
                {/* Icon */}
